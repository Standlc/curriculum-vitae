...
export default function ClipboardEmailNotification() {
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full flex justify-center z-30">
      <div className="font-mono absolute bottom-[50px] animate-clipboard-animation rounded-2xl border border-[rgba(255,255,255,0.1)] px-4 py-3 bg-black bg-opacity-50 backdrop-blur-lg flex items-center gap-3">
