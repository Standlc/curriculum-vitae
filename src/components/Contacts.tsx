...
export default function Contacts({ compact = false }: {compact?: boolean;}) {
  ...
  return (
    <div className="flex gap-5 w-full items-center justify-center select-none">
      <a
        href="https://github.com/Standlc"
        target="_blank"
        className="flex gap-2 items-center hover:underline"
      >
        {!compact && <span className="opacity-text font-mono text-sm">GitHub</span>}
        <GitHub />
      </a>

      <a
        href="https://www.linkedin.com/in/stan-de-la-comble/"
        target="_blank"
        className="flex gap-2 items-center hover:underline"
      >
        {!compact && <span className="opacity-text font-mono text-sm">LinkedIn</span>}
        <LinkedIn />
      </a>

      <a
        href="https://x.com/StanDelacomble"
        target="_blank"
        className="flex gap-2 items-center hover:underline"
      >
        {!compact && <span className="opacity-text font-mono text-sm">Twitter</span>}
        <X />
      </a>
      ...
      <div className="flex items-center relative justify-center">
        ...
        >
          {!compact && <span className="opacity-text font-mono text-sm">Email</span>}
          <Mail />
        </div>
